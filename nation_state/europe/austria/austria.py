...
def main(time1):
    ...
    if not austria.sprite:
        ...
        while austria.population > 6000000:
            print(f"Current Date: {austria.date}\n")
            time.sleep(1.5)
            austria.population_change()
            austria.check_economic_state()
            austria.stability_happiness_change(globe1)
