...
def main(time1):
    ...
    if not french.sprite:
        ...
        establish_foreign_nations(globe1, american_ai, englisn_ai, canadian_ai, cuban_ai, chinese_ai, japanese_ai,
                                austrian_ai, dutch_ai, french, spanish_ai, italian_ai, lux_ai,
        ...
        while french.population > 6000000:
            print(f"Current Date: {french.date}\n")
            time.sleep(1.5)
            french.population_change()
            french.check_economic_state()
            french.stability_happiness_change(globe1)
