...
def main(time1):
    ...
    if not greek.sprite:
        ...
        establish_foreign_nations(globe1, american_ai, englisn_ai, canadian_ai, cuban_ai, chinese_ai, japanese_ai,
                                austrian_ai, dutch_ai, greek, spanish_ai, italian_ai, lux_ai,
        ...
        while greek.population > 6000000:
            print(f"Current Date: {greek.date}\n")
            time.sleep(1.5)
            greek.population_change()
            greek.check_economic_state()
            greek.stability_happiness_change(globe1)
