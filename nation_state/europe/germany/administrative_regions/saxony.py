    ...
    if a_l.current_date > a_l.economic_change_date:
        if a_l.current_gdp > a_l.past_gdp:
            ...
            if a_l.economic_state == "recovery":
                ...
                choice = input(
                    "The administrative region of Saxony is requesting that you pass an economic stimulus.\n"
                    "The Saxon economy is starting to fail. Will you do this?: ")
                ...
                if choice.lower() == "yes" or choice.lower() == 'y':
                    ...
                    if chance % 6 == 0:
                        ...
                        print("Saxon officials decided to go around your back an establish a stimulus anyway.\n")
                        a_l.master.economic_stimulus = True
                ...
                choice = input(
                    "The administrative region of Saxony is requesting that you pass an economic stimulus.\n"
                    "The Saxon economy has fallen into a depression. Will you do this?: ")
