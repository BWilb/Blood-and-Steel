...
def diplomats_kicked_out():
    print("your diplomats have been kicked out of Luxembourg.\n")
    time.sleep(1.5)

def luxembourger_relations(self, luxembourg, globe):
    # self represents the US
    # self represents the US
    positive = ["\n1. improve relations for 60 days(15 political power, decrease pp exponent by 0.2 points)",
                "2. guarantee Luxembourger independence(10 initial political power, decrease pp exponent by 0.5 points",
                "3. increase exports to Luxembourg for 60 days(25 political power, improves US economy)",
                f"4. establish a {self.name} embassy within Luxembourg City(13 political power cost, decrease 0.1 pp exponent while its installed",
                "5. establish an economic treaty with Luxembourg(15 political power, improves both economies)",
                "6. establish a military alliance with Luxembourg(10 political power)",
                "7. Establish student transfer student program(improve economy for 120 days)"]

    negative = ["1. Expel Luxembourger nationals(15 political power; loss in US population, worsen relations by 25%, potential for British involvement)",
                "2. Jail Luxembourger nationals\n(25 political power; worsen relations by 1.25% every day nationals are in jail)",
                "4. Embargo Luxembourger economy\n(worsen relations by 35%, hurts both economies by 25%)",
                "5. Leave alliance\n(if not in alliance will not affect relationship)",
                "6. Hurt Luxembourger relations for 30 days\n(15 political power initially, decrease by 0.75% every day)",
                "7. Declare war on Luxembourg(allies will be potentially involved)"]
    done = True
    while done:
        type_choice = input("\nWould you like to improve or hinder relations with Luxembourg?(enter quit to escape)\n"
        ...
        if type_choice.lower() == "improve":
            ...
            if globe.tension < 50 and self.luxembourg_relations > 50:
                ...
                if relation_choice == 1:
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            ...
                            print(f"{luxembourg.leader} has agreed to improve relations with {self.name}.\n")
                            ...
                            self.luxembourg_relations -= round(random.uniform(1, 2), 2)
                            ...
                            self.luxembourg_relations -= round(random.uniform(1, 6), 2)
                ...
                elif relation_choice == 2 and not self.guarantee_luxembourg:
                    if self.political_power >= 10:
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{luxembourg.leader} has accepted our guarantee for their independence.\n")
                            self.political_exponent -= 0.5
                            self.guarantee_luxembourg = True
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 25:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{luxembourg.leader} has agreed to buy more {self.name} goods.\n")
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 13:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{luxembourg.leader} has agreed to install a(n) {self.name} embassy within Luxembourg City.\n")
                    ...
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(
                                f"{luxembourg.leader} has agreed to establish an economic treaty with {self.name}\n")
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 10:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            if luxembourg.alliance:
                                print(f"{luxembourg.leader} has allowed us to enter the {luxembourg.alliance}\n")
                                time.sleep(1.5)
                            else:
                                print(f"{luxembourg.leader} has agreed to forming a military alliance")
                                time.sleep(1.5)
                                alliance = input("what would you like to name your alliance?: ")
                                self.alliance = alliance
                                luxembourg.alliance = alliance
                    ...
                    if chance % 2 == 0:
                        """49.1% chance that British parliament accepts proposal"""
                        print(f"{luxembourg.leader} has agreed to establish a student transfer program\n")
                        time.sleep(1.5)

                    elif chance % 3 == 1:
                        """33.8% chance that US diplomats get kicked out of Britain"""
                        print("Your diplomats have been kicked out of Legislature.\n")
                        time.sleep(1.5)
                        globe.tension += round(random.uniform(0.5, 2), 2)
                        self.luxembourg_relations -= round(random.uniform(1, 2), 2)
            ...
            if globe.tension < 50 and self.luxembourg_relations < 50:
            ...
            elif globe.tension > 50 and self.luxembourg_relations > 50:
                ...
                if relation_choice == 1:
                    ...
                    if self.political_power >= 25:
                        ...
                        if chance % 3 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{luxembourg.leader} has agreed to buy more American goods.\n")
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 13:
                        ...
                        if chance % 3 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{luxembourg.leader} has agreed to install an US embassy within Mexico City.\n")
                            self.political_exponent -= 0.1
                            time.sleep(1.5)
            ...
            if relations_choice == 1:
                if not self.luxembourg_nationals_dealt:
                    ...
                    if self.political_power >= 15:
                        ...
                        print(f"We have expelled {nationals} luxembourger nationals from our lands.\n")
                        time.sleep(1.25)
                        self.population -= nationals
                        luxembourg.population += nationals

                        self.luxembourg_relations -= self.luxembourg_relations * 0.25
                    ...
                    print("You have already dealt with Luxembourg Nationals within your territory.\n")
                    time.sleep(1.25)
                ...
                if not self.luxembourg_nationals_dealt:
                    if self.political_power >= 25:
                        self.political_power -= 25
                        nationals = random.randrange(3000, 10000)
                        print(f"We have jailed {nationals} luxembourger nationals.\n")
                        time.sleep(1.25)
                        self.luxembourg_relations -= self.luxembourg_relations * 0.0125
                    ...
                    print("You have already dealt with the Luxembourger Nationals within your territory.\n")
                    time.sleep(1.25)
                ...
                if not self.luxembourg_nationals_dealt:
                    ...
                    if self.political_power >= 15:
                        ...
                        nationals = random.randrange(3000, 10000)
                        print(f"We have killed {nationals} Luxembourgers on claims of espionage.\n")
                        time.sleep(1.25)
                        self.population -= nationals
                        self.luxembourg_relations -= self.luxembourg_relations * 0.5
                ...
                if not self.luxembourg_embargo:
                    ...
                    luxembourg.current_gdp -= luxembourg_loss

                    self.luxembourg_relations -= self.luxembourg_relations * 0.25
                    globe.tension += round(random.uniform(3.45, 5.56), 2)
                else:
                    print("You currently have luxembourg under an embargo!!.")
                    time.sleep(1.25)

            elif relations_choice == 5:
                if self.alliance.lower() == luxembourg.alliance.lower():
                    print(f"You have decided to leave the {self.alliance}.\n")
                    time.sleep(1.25)

            elif relations_choice == 6:
                if self.political_power >= 15:
                    print("you have decided to insult your relations with Luxembourg for 30 days.\n")
                    time.sleep(1.25)

            elif relations_choice == 7:
                choice = input("Are you sure you want to declare war Luxembourg?: ")
                if choice.lower() == "yes" or choice.lower() == "y":
                    print("you have now officially declared war Luxembourg.\n")
                    time.sleep(1.25)
