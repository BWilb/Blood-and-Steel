...
def luxembourger_relations(self, luxembourg, globe):
    ...
    positive = ["\n1. improve relations for 60 days(15 political power, decrease pp exponent by 0.2 points)",
                ...
                "4. establish a US embassy within Luxembourg City(13 political power cost, decrease 0.1 pp exponent while its installed",
                ...
                if relation_choice == 1:
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            ...
                            print(f"{luxembourg.leader} has agreed to improve relations with the United States.\n")
                            ...
                            luxembourg.us_relations -= round(random.uniform(1, 2), 2)
                            ...
                            luxembourg.us_relations -= round(random.uniform(1, 6), 2)
                    ...
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(
                                f"{luxembourg.leader} has agreed to establish an economic treaty with the United States\n")
                            time.sleep(1.5)
            ...
            if relations_choice == 1:
                if not self.nationals_dealt:
                    ...
                    if self.political_power >= 15:
                        ...
                        self.luxembourg_relations -= self.luxembourg_relations * 0.
