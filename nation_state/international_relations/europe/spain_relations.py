...
def spanish_relations(self, spain, globe):
    # self represents the US
    # self represents the US
    positive = ["\n1. improve relations for 60 days(15 political power, decrease pp exponent by 0.2 points)",
                "2. guarantee Spain independence(10 initial political power, decrease pp exponent by 0.5 points",
                "3. increase exports to Spain for 60 days(25 political power, improves US economy)",
                "4. establish a US embassy within Madrid(13 political power cost, decrease 0.1 pp exponent while its installed",
                "5. establish an economic treaty with Spain(15 political power, improves both economies)",
                "6. establish a military alliance with Spain(10 political power)",
                "7. Establish student transfer student program(improve economy for 120 days)"]

    negative = ["1. Expel Spanish nationals(15 political power; loss in US population, worsen relations by 25%)",
                "2. Jail Spanish nationals\n(25 political power; worsen relations by 1.25% every day nationals are in jail)",
                "4. Embargo Spanish economy\n(worsen relations by 35%, hurts both economies by 5%)",
                "5. Leave alliance\n(if not in alliance will not affect relationship)",
                "6. Hurt Spanish relations for 30 days\n(15 political power initially, decrease by 0.75% every day)",
                "7. Declare war on Spain(potential for other nations to get involved if Spain is in alliance)."]
    done = True
    while done:
        type_choice = input("\nWould you like to improve or hinder relations with Spain?(enter quit to escape)\n"
        ...
        if type_choice.lower() == "improve":
            ...
            if globe.tension < 50 and self.spain_relations > 50:
                ...
                if relation_choice == 1:
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            ...
                            print(f"{spain.leader} has agreed to improve relations with the United States.\n")
                            self.political_exponent -= 0.2
                            time.sleep(1.5)

                        elif chance % 3 == 1:
                            """33.3% chance that US diplomats get kicked out of Britain"""
                            print("Your diplomats have been kicked out of Spanish Legislature.\n")
                            time.sleep(1.5)
                            globe.tension += round(random.uniform(0.5, 2), 2)
                            spain.us_relations -= round(random.uniform(1, 2), 2)
                            ...
                            spain.us_relations -= round(random.uniform(1, 6), 2)
                    ...
                    if self.political_power >= 10:
                        if chance % 2 == 0:
                            ...
                            print(f"{spain.leader} has accepted our guarantee for their independence.\n")
                    ...
                    if self.political_power >= 25:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{spain.leader} has agreed to buy more American goods.\n")
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 13:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(f"{spain.leader} has agreed to install an US embassy within Madrid.\n")
                    ...
                    if self.political_power >= 15:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            print(
                                f"{spain.leader} has agreed to establish an economic treaty with the United States\n")
                            time.sleep(1.5)
                    ...
                    if self.political_power >= 10:
                        ...
                        if chance % 2 == 0:
                            """49.1% chance that British parliament accepts proposal"""
                            if spain.alliance:
                                print(f"{spain.leader} has allowed us to enter the {spain.alliance}\n")
                                time.sleep(1.5)
                            else:
                                print(f"{spain.leader} has agreed to forming a military alliance")
                                time.sleep(1.5)
                                alliance = input("what would you like to name your alliance?: ")
                                self.alliance = alliance
                                spain.alliance = alliance

                        elif chance % 3 == 1:
                            """33.8% chance that US diplomats get kicked out of Britain"""
                            print("Your diplomats have been kicked out of the Spanish Legislature.\n")
                            time.sleep(1.5)
                            globe.tension += round(random.uniform(0.5, 2), 2)
                            spain.us_relations -= round(random.uniform(1, 2), 2)
                            self.spain_relations -= round(random.uniform(1, 2), 2)
                    ...
                    if chance % 2 == 0:
                        """49.1% chance that British parliament accepts proposal"""
                        print(f"{spain.leader} has agreed to establish a student transfer program\n")
                        time.sleep(1.5)
            ...
            elif globe.tension > 50 and self.spain_relations > 50:
            ...
            if relations_choice == 1:
                if not self.spain_nationals_dealt:
                    ...
                    if self.political_power >= 15:
                        ...
                        print(f"We have expelled {nationals} Spanish nationals from our lands.\n")
                        time.sleep(1.25)
                        ...
                        spain.population += nationals
                        self.spain_relations -= self.spain_relations * 0.25
                    ...
                    print("You have already dealt with the Spanish Nationals within US territory.\n")
                    time.sleep(1.25)
                ...
                if not self.spain_nationals_dealt:
                    if self.political_power >= 25:
                        self.political_power -= 25
                        nationals = random.randrange(3000, 1000000)
                        print(f"We have jailed {nationals} Spanish nationals.\n")
                        time.sleep(1.25)
                        self.spanish_relations -= self.spain_relations * 0.0125
                ...
                if not self.cuba_nationals_dealt:
                    ...
                    if self.political_power >= 15:
                        ...
                        """expelling british nationals"""
                        nationals = random.randrange(3000, 1000000)
                        print(f"We have killed {nationals} Spanish on claims of espionage.\n")
                        time.sleep(1.25)
                        self.population -= nationals
                        for i in range(0, len(self.states)):
                            ...
                            """portion of each state's population being taken away"""
                        self.spanish_relations -= self.spain_relations * 0.5
                ...
                if not self.britain_embargo:
                    ...
                    spain_loss = (spain.current_gdp * 0.10)
                    ...
                    print("You currently have Spain under an embargo!!.")
                    time.sleep(1.25)

            elif relations_choice == 5:
                if self.alliance.lower() == spain.alliance.lower():
                    print(f"You have decided to leave the {self.alliance}.\n")
                    time.sleep(1.25)

            elif relations_choice == 6:
                if self.political_power >= 15:
                    print("you have decided to insult your relations with Spain for 30 days.\n")
                    time.sleep(1.25)

            elif relations_choice == 7:
                choice = input("Are you sure you want to declare war on Spain?: ")
                if choice.lower() == "yes" or choice.lower() == "y":
                    print("you have now officially declared war on Spain.\n")
                    time.sleep(1.25)
