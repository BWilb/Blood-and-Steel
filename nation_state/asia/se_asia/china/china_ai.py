        ...
        if not self.is_sprite:
            if self.current_year < self.date.year:
                ...
                if pop_change < 2.56:
                    ...
                    if choice == 1:
                        print("The Chinese government has decided to implement policies to increase growth in births.\n")
                        time.sleep(1.25)
                    ...
                    if choice == 1:
                        print("The Chinese government has decided to implement policies to control births.\n")
                        time.sleep(1.25)
            ...
            if self.birth_enhancer:
                births = random.randrange(20, 250)
                deaths = random.randrange(25, 245)
                self.population += (births - deaths)
                self.births += births
                self.deaths += deaths

            if self.birth_control:
                births = random.randrange(40, 200)
                deaths = random.randrange(45, 210)
                self.population += (births - deaths)
                self.births += births
                self.deaths += deaths

            else:
                births = random.randrange(30, 225)
                deaths = random.randrange(35, 235)
                self.population += (births - deaths)
                self.births += births
                self.deaths += deaths
    # economic functions
