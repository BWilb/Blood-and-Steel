        ...
        if self.current_year < self.date.year:
            ...
            if pop_change < 2.56:
                ...
                if self.master_nation.birth_enhancer:
                    births = random.randrange(4, 10)
                    deaths = random.randrange(2, 4)
                ...
                if self.master_nation.birth_control:
                    births = random.randrange(3, 7)
                    deaths = random.randrange(5, 9)
                    self.population += (births - deaths)
                    self.master_nation.population += (births - deaths)
                    self.births += births
                    self.master_nation.births += births
                    ...
                    births = random.randrange(2, 8)
                    deaths = random.randrange(3, 5)
                    self.population += (births - deaths)
                    self.master_nation.population += (births - deaths)
                    self.births += births
                    self.master_nation.births += births
